...
public interface BoletoRepository extends JpaRepository<Boleto, Long> {
        ...
        // Agregas este método para obtener los boletos de una rifa específica ordenados
        // por número de boleto
        List<Boleto> findByRifaIdOrderByNumeroBoletoAsc(Long rifaId);

        // Agregas este método para obtener los boletos de una rifa específica junto con
        // la información del usuario que los compró, ordenados por número de boleto
        ...
        // Agregas este método para obtener los boletos de una rifa específica filtrados
        // por estado
        List<Boleto> findByRifaIdAndEstado(Long rifaId, String estado);
        //List<Boleto> findByRifaIdAndEstado(Long rifaId, String estado);

        // Agregas este método para obtener los boletos de una rifa específica filtrados
        // por estado y ordenados por número de boleto
        ...
        // Obtiene los boletos de una rifa específica ordenados por número de boleto en
        // orden descendente
        ...
        long countByRifaIdAndEstado(Long rifaId, String estado);
